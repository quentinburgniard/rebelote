class Execution {
  ...
  get #firstStep() {
    return this.steps ? this.steps.reduce((firstStep, step) => firstStep.createdAt < step.createdAt ? firstStep : step) : null;
  }

  get #lastStep() {
    return this.steps ? this.steps.reduce((lastStep, step) => lastStep.createdAt > step.createdAt ? lastStep : step) : null;
  }
}
